...
const TOPICS = [
  ...
  "The Lab · early access application",
...
const TOPIC_PARAM_MAP: Record<string, string> = {
  ...
  lab: "The Lab · early access application",
};
...
export default function ContactChannel() {
  ...
  const isLabWaitlist = topic === "The Lab · early access application";
  // Doc requests are complete without prose. The early-access application
  // is deliberately not — it's an application, and the writing is the
  // qualifying artifact.
  const messageOptional = isDocRequest;
          ...
          <form className="ctc-form" onSubmit={submit}>
            ...
            <div className="ctc-grid">
              ...
              <label className="ctc-field">
                ...
                {isLabWaitlist && (
                  <span className="ctc-hint">
                    Applications are read by the builders — cohort one is
                    capped small on purpose. We reply to your company inbox
                    either way.
                  </span>
                )}
              </label>
              ...
              <textarea
                ...
                placeholder={
                  isDocRequest
                    ...
                    : isLabWaitlist
                      ? "The strongest applications name the motion we'd instrument — team size, deal shape, what you'd want the console to read first."
